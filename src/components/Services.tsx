      ...
      <div className="container-custom relative">
        ...
        <div className="max-w-4xl mb-20">
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-sm uppercase tracking-[0.25em] text-secondary-dark font-semibold">What We Offer</span>
          </div>
            ...
            >
              ...
              <div className="relative h-full bg-card border-2 border-card-border hover:border-secondary/40 rounded-2xl p-10 transition-all duration-500 hover:shadow-premium-lg hover:-translate-y-2">
                ...
                <div className="relative mb-8">
                  <div className={`w-16 h-16 bg-gradient-to-br ${service.accent} flex items-center justify-center rounded-xl group-hover:scale-110 transition-all duration-500`}>
        ...
        <div className="mt-24 text-center">
          ...
          <button className="group inline-flex items-center gap-3 text-secondary hover:text-secondary-dark transition-colors">
            <span className="text-base font-semibold uppercase tracking-wider">View All Services</span>

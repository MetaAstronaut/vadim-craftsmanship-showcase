...
const Footer = () => {
  const quickLinks = [
    ...
    { name: "Specialized Services", href: "/other-services" },
    ...
    <footer className="bg-primary pt-24 pb-12 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-16">
          {/* Company Info */}
          <div>
            <h3 className="text-3xl font-bold mb-6 text-white font-['Playfair_Display']">The Vadim Group</h3>
            <p className="text-white/60 text-base leading-relaxed mb-6">
              Premium repair services for homes, businesses, marine vessels, and luxury vehicles throughout the Orlando area.
            </p>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-white/10 hover:bg-secondary/20 flex items-center justify-center transition-colors duration-300 border border-white/10">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-semibold mb-8 text-white uppercase tracking-wider">Quick Links</h3>
            <nav className="space-y-4">
              {quickLinks.map((link) => (
                <Link
                  key={link.name}
                  to={link.href}
                  className="block text-white/60 hover:text-secondary-light transition-colors text-base group"
                >
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 text-white/60 group">
                <MapPin className="h-5 w-5 text-secondary-light mt-1 flex-shrink-0 transition-transform group-hover:scale-110" />
        ...
        <div className="border-t border-white/10 pt-10 mt-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm text-white/40">
              ...
              <a href="#" className="hover:text-secondary-light transition-colors">Terms of Service</a>
            </div>
          </div>
        </div>
      </div>
